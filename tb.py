...
cl = LINETCR.LINE()
cl.login(token="EpYmS0wKLoGEXB6HglF7.TqW/sCzbwO+FPsMD5Kz+fW.888QIzSkJMj9YyuD6t8/dKBPrSCItl/icADUoLVCXLo=")
...
def bot(op):
    try:
                ...
                if Amid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("client¤¬õí¤êÒ?ÖÆor¥°¥ë©`¥×¤Ë´æÔÚ¤·¤Ê¤¤?é¡¢\n["+op.param1+"]\n¤Î\n["+op.param2+"]\n¤òõí¤ëÊÂ¤¬¤Ç¤­¤Þ¤»¤ó¤Ç¤·¤¿¡£\n¥Ö¥é¥Ã¥¯¥ê¥¹¥È¤Ë×·¼Ó¤·¤Þ¤¹¡£")
                        if op.param2 in wait["blacklist"]:
                            pass
                        if op.param2 in wait["whitelist"]:
                            pass
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
				...
				if msg.from_ in admin:
					...
					kk.sendMessage(msg)
            elif msg.text in ["Ã¦â??â?1¤7ºÃ£ÂÂ®Ã£Æ?â?1¤7?Ã£Æ?Â¬Ã£â?1¤7?Â¼Ã£Æ?Â³Ã£Æ?Ë?1¤7","Gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					...
					msg.text = None
					cl.sendMessage(msg)
            elif msg.text in ["Ã¦â??â?1¤7ºÃ£ÂÂ®Ã£Æ?â?1¤7?Ã£Æ?Â¬Ã£â?1¤7?Â¼Ã£Æ?Â³Ã£Æ?Ë?1¤7","Cv1 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					ki.sendMessage(msg)
            elif msg.text in ["Ã¦â??â?1¤7ºÃ£ÂÂ®Ã£Æ?â?1¤7?Ã£Æ?Â¬Ã£â?1¤7?Â¼Ã£Æ?Â³Ã£Æ?Ë?1¤7","Cv2 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					kk.sendMessage(msg)
            elif msg.text in ["Ã¦â??â?1¤7ºÃ£ÂÂ®Ã£Æ?â?1¤7?Ã£Æ?Â¬Ã£â?1¤7?Â¼Ã£Æ?Â³Ã£Æ?Ë?1¤7","Cv3 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					kc.sendMessage(msg)
            elif msg.text in ["Ã¦â??â?1¤7ºÃ£ÂÂ®Ã£Æ?â?1¤7?Ã£Æ?Â¬Ã£â?1¤7?Â¼Ã£Æ?Â³Ã£Æ?Ë?1¤7","All gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
		...
		for ticket_id in n_links:
              ...
              if msg.from_ in admin:
                if wait["ProtectQR"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Ã©â?¬Â£Ã§ÂµÂ¡Ã¥â?1¤7¦Ë?1¤7:Ã£â??ÂªÃ£Æ?Â?1¤7","K on","Contact on","Ã©Â¡Â¯Ã§Â¤ÂºÃ¯Â¼Å¡Ã©â??â?1¤7?1¤7"]:
				if msg.from_ in admin:
					if wait["contact"] == True:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"done")
            elif msg.text in ["Ã©â?¬Â£Ã§ÂµÂ¡Ã¥â?1¤7¦Ë?1¤7:Ã£â??ÂªÃ£Æ?â?1¤7?1¤7","K off","Contact off","Ã©Â¡Â¯Ã§Â¤ÂºÃ¯Â¼Å¡Ã©â??Å?1¤7"]:
				if msg.from_ in admin:
					if wait["contact"] == False:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"done")
            elif msg.text in ["Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¥Ââ?1¤7?Ã¥Å?1¤7 :Ã£â??ÂªÃ£Æ?Â?1¤7","Join on","Auto join:on","Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¥ÂÆ?Ã¥Å?1¤7 Ã¯Â¼Å¡Ã©â??â?1¤7?1¤7"]:
				if msg.from_ in admin:
					if wait["autoJoin"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"done")
            elif msg.text in ["Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¥Ââ?1¤7?Ã¥Å?1¤7 :Ã£â??ÂªÃ£Æ?â?1¤7?1¤7","Join off","Auto join:off","Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¥ÂÆ?Ã¥Å?1¤7 Ã¯Â¼Å¡Ã©â??Å?1¤7"]:
				if msg.from_ in admin:
					...
					try:
						...
						if strnum == "off":
							...
							if wait["lang"] == "JP":
								...
								cl.sendText(msg.to,"Ã¥â?¦Â³Ã¤Âºâ?1¤7 Ã©â?1¤7?â?¬Ã¨Â¯Â·Ã¦â?¹â?1¤7?Ã§Â»ÂÃ£â?¬â??Ã¨Â¦ÂÃ¦â?1¤7?Â¶Ã¥Â¼â?¬Ã¨Â¯Â·Ã¦Å?â?¡Ã¥Â®Å¡Ã¤ÂºÂºÃ¦â?1¤7¢Â°Ã¥Ââ?1¤7?Ã©â?¬Â")
						else:
							num =  int(strnum)
							...
							if wait["lang"] == "JP":
								...
								cl.sendText(msg.to,strnum + "Ã¤Â½Â¿Ã¤ÂºÂºÃ¤Â»Â¥Ã¤Â¸â?¹Ã§Å¡â?1¤7?Ã¥Â°ÂÃ§Â»â?1¤7?Ã§â?1¤7Â¨Ã¨â?1¤7¡ÂªÃ¥Å Â¨Ã©â?1¤7?â?¬Ã¨Â¯Â·Ã¦â?¹â?1¤7?Ã§Â»Â?1¤7")
					except:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"Value is wrong")
						else:
							cl.sendText(msg.to,"Bizarre ratings")
            elif msg.text in ["Ã¥Â¼Â·Ã¥Ë?Â¶Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã©â?¬â?¬Ã¥â?1¤7¡Â?1¤7:Ã£â??ÂªÃ£Æ?Â?1¤7","Leave on","Auto leave:on","Ã¥Â¼Â·Ã¥Ë?Â¶Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã©â?¬â?¬Ã¥â?1¤7¡ÂºÃ¯Â¼Å¡Ã©â?1¤7?â?1¤7?1¤7"]:
				if msg.from_ in admin:
					if wait["leaveRoom"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
            ...
            elif msg.text in ["Ã¥Â¼Â·Ã¥Ë?Â¶Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã©â?¬â?¬Ã¥â?1¤7¡Â?1¤7:Ã£â??ÂªÃ£Æ?â?1¤7?1¤7","Leave off","Auto leave:off","Ã¥Â¼Â·Ã¥Ë?Â¶Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã©â?¬â?¬Ã¥â?1¤7¡ÂºÃ¯Â¼Å¡Ã©â?1¤7?Å?1¤7"]:
				if msg.from_ in admin:
					if wait["leaveRoom"] == False:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"already")
            elif msg.text in ["Ã¥â?¦Â±Ã¦Å?â?1¤7?1¤7:Ã£â??ÂªÃ£Æ?Â?1¤7","Share on","Share on"]:
				if msg.from_ in admin:
					if wait["timeline"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"Ã¨Â¦ÂÃ¤Âºâ? Ã¥Â¼â?¬Ã£â?¬â?1¤7?1¤7")
            elif msg.text in ["Ã¥â?¦Â±Ã¦Å?â?1¤7?1¤7:Ã£â??ÂªÃ£Æ?â?1¤7?1¤7","Share off","Share off"]:
				if msg.from_ in admin:
				...
				if msg.from_ in admin:
					...
					if album["result"]["items"] == []:
						...
						if wait["lang"] == "JP":
							...
							mg = "Ã¤Â»Â¥Ã¤Â¸â?¹Ã¦Ë?Â¯Ã¥Â¯Â¹Ã¨Â±Â¡Ã§Å¡â?1¤7?Ã§â?1¤7ºÂ¸Ã¥â?1¤7 Å?1¤7"
				...
				if msg.from_ in admin:
					...
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,str(i) + "Ã¥Ë? Ã©â?¢Â¤Ã¤Âºâ?1¤7 Ã¤Âºâ?1¤7¹Ã§Å¡â?1¤7?Ã§â?1¤7ºÂ¸Ã¥â?1¤7 Å?Ã£â?¬â??1¤7")
            elif msg.text in ["Group id","Ã§Â¾Â¤Ã§Âµâ??Ã¥â?1¤7¦Â¨id"]:
				if msg.from_ in admin:
				...
				if msg.from_ in admin:
					...
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,"Ã¦â?¹â?1¤7?Ã§Â»ÂÃ¤Âºâ?1¤7 Ã¥â?1¤7¦Â¨Ã©Æ?Â¨Ã§Å¡â?1¤7?Ã©â?1¤7?â?¬Ã¨Â¯Â·Ã£â?¬â?1¤7?1¤7")
				...
				if msg.from_ in admin:
					...
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,str(i) + "Ã¥Ë? Ã©â?¢Â¤Ã¤Âºâ?1¤7 Ã¤Âºâ?1¤7¹Ã§Å¡â?1¤7?Ã§â?1¤7ºÂ¸Ã¥â?1¤7 Å?Ã£â?¬â??1¤7")
            elif msg.text in ["Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¨Â¿Â½Ã¥Å?1¤7 :Ã£â??ÂªÃ£Æ?Â?1¤7","Add on","Auto add:on","Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¨Â¿Â½Ã¥Å?1¤7 Ã¯Â¼Å¡Ã©â??â?1¤7?1¤7"]:
				if msg.from_ in admin:
					if wait["autoAdd"] == True:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"already on")
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"Ã¨Â¦ÂÃ¤Âºâ? Ã¥Â¼â?¬Ã£â?¬â?1¤7?1¤7")
            elif msg.text in ["Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¨Â¿Â½Ã¥Å?1¤7 :Ã£â??ÂªÃ£Æ?â?1¤7?1¤7","Add off","Auto add:off","Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã¨Â¿Â½Ã¥Å?1¤7 Ã¯Â¼Å¡Ã©â??Å?1¤7"]:
				if msg.from_ in admin:
				...
				if msg.from_ in admin:
					if wait["lang"] == "JP":
						...
						cl.sendText(msg.to,"The automatic appending information is set as followsÃ£â?¬â?1¤7?\n\n" + wait["message"])
				...
				if msg.from_ in admin:
					...
					if c in [""," ","\n",None]:
						...
						wait["comment"] = c
						cl.sendText(msg.to,"changed\n\n" + c)
            elif msg.text in ["Ã£â??Â³Ã£Æ?Â¡Ã£Æ?Â³Ã£Æ?Ë?1¤7:Ã£â??ÂªÃ£Æ?Â?1¤7","Comment on","Comment:on","Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã©Â¦â?1¤7?Ã?1¤7 ÂÃ§â?¢â?¢Ã¨Â¨â?¬Ã¯Â¼Å¡Ã©â?1¤7?â?1¤7?1¤7"]:
				if msg.from_ in admin:
					if wait["commentOn"] == True:
						...
						if wait["lang"] == "JP":
							...
							cl.sendText(msg.to,"Ã¨Â¦ÂÃ¤Âºâ? Ã¥Â¼â?¬Ã£â?¬â?1¤7?1¤7")
            elif msg.text in ["Ã£â??Â³Ã£Æ?Â¡Ã£Æ?Â³Ã£Æ?Ë?1¤7:Ã£â??ÂªÃ£Æ?â?1¤7?1¤7","Comment on","Comment off","Ã¨â?¡ÂªÃ¥â?1¤7¹â?1¤7¢Ã©Â¦â?1¤7?Ã?1¤7 ÂÃ§â?¢â?¢Ã¨Â¨â?¬Ã¯Â¼Å¡Ã©â?1¤7?Å?1¤7"]:
				if msg.from_ in admin:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Chomel pekok ô??ô???Har Harô¿¿")
					kk.sendText(msg.to,"Chomel pekok ô??ô???Har Harô¿¿")
					kc.sendText(msg.to,"Chomel pekok ô??ô???Har Harô¿¿")
...
#-----------------------------------------------
				...
				ki.sendText(msg.to,"Mamanx ô??ô???Har Harô¿¿")
				kk.sendText(msg.to,"Ngentod ô??ô???Har Harô¿¿")
				kc.sendText(msg.to,"Yuuk ô??ô???Har Harô¿¿")
#-----------------------------------------------
